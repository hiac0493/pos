...
namespace CrearTicketVenta
{
    public class CreateTicket
    {
        ...
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 48 caracteres
            linea.AppendLine("DESCRIPCIÓN             N#     PRECIO      TOTAL");
        }
        ...
        //Metodo para agregar los totales d ela venta
        public void AgregarTotalesCentrado(string texto, float total)
        {
            //Variables que usaremos
            string resumen, valor, textoCompleto, espacios = "", espaciosIzquierda = "                       ";
            ...
            { resumen = espaciosIzquierda + texto; }

            textoCompleto = resumen;
            valor = total.ToString("C2");//Agregamos el total previo formateo.
        ...
        public void AgregaArticulo(string articulo, double cant, double precio, double importe)
        {
            ...
            if (cant.ToString().Length <= 5 && precio.ToString().Length <= 8 && importe.ToString().Length <= 9)
            {
        ...
        {
            linea.AppendLine("\x1B" + "d" + "\x05"); //Avanza 9 renglones, Tambien varian
            linea.AppendLine("\x1B" + "\x69"); //Caracteres de corte. Estos comando varian segun el tipo de impresora
        }
        //Para abrir el cajon
        ...
        public void ImprimirTicket(string impresora)
        {
            ...
            //RawPrinterHelper.SendFileToPrinter(impresora, "C:\\VSProject\\checkpointposapp\\checkpoint\\checkpoint\\Resources\\LogoCheckpoint.png");
